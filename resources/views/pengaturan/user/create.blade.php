        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" method="POST" action="{{route('pengaturan.user.store')}}">
                    @csrf
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            {!! Form::email('email', null, ['class'=>'form-control '.( $errors->has('email') ? ' is-invalid' : '' ),'placeholder'=>'Enter email','required']) !!}
                            @error('email')
                                <span class="error invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group col-6">
                            ...
                            {!! Form::password('password', ['class'=>'form-control '.( $errors->has('password') ? ' is-invalid' : '' ),'placeholder'=>'Enter password','required']) !!}
                            @error('password')
                              <span class="error invalid-feedback">
                                {{ $message }}
                              </span>
                        ...
                        <div class="form-group col-6">
                          ...
                          {!! Form::password('password_confirmation', ['class'=>'form-control '.( $errors->has('password') ? ' is-invalid' : '' ),'placeholder'=>'Enter password','required']) !!}
                          @error('password')
                            <span class="error invalid-feedback">
                              {{ $message }}
                            </span>
