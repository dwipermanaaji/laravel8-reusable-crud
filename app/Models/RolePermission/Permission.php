...
class Permission extends Resource implements PermissionContract
{
    use HasRoles;
    ...
    public function sub_module_permission()
    {
        return $this->belongsTo(SubModulePermission::class,'sub_module_permission_id','id');
    }
